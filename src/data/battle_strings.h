...
const u8 BattleText_SpeedRisen[] = _("{STRING 16}{B_TXT_EUNNEUN} {STRING 23} 때문에\n스피드가 올라갔다!"); // §たは §ぬでｎすばやさが あがった!
...
const u8 BattleText_SentOutDouble4[] = _("가랏! {STRING 2}{B_TXT_WAGWA} {STRING 4}!"); // ゆけっ! §いと §え!
const u8 BattleText_SentOutSingle7[] = _("가랏! {STRING 0}!"); // ゆけっ! § !
const u8 BattleText_SentOutSingle8[] = _("다녀와! {STRING 0}!"); // いってこい! § !
...
const u8 BattleText_ComeBackSingle1[] = _("{STRING 0} 이제 됐어!\n돌아와!"); // §  もういい!ｎもどれ!
