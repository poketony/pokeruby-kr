...
const u8 BattleText_WildAppeared1[] = _("앗! 야생 {STRING 3}{B_TXT_IGA} 튀어나왔다!\p");
const u8 BattleText_WildAppeared2[] = _("앗! 야생 {STRING 3}{B_TXT_IGA} 나타났다!\p");
const u8 BattleText_WildAppeared3[] = _("앗! 야생 {STRING 3}{B_TXT_IGA} 튀어나왔다!{PAUSE 127}");
const u8 BattleText_WildDoubleAppeared[] = _("앗! 야생 {STRING 5}{B_TXT_WAGWA}\n{STRING 3}{B_TXT_IGA} 튀어나왔다!\p");
