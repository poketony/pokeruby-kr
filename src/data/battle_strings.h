...
const u8 BattleText_MenuOptions[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}FIGHT{CLEAR_TO 48}BAG\nPOKéMON{CLEAR_TO 48}RUN");
const u8 BattleText_MenuOptionsSafari[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}BALL{CLEAR_TO 48}{POKEBLOCK}\nGO NEAR{CLEAR_TO 48}RUN");
...
const u8 BattleText_SpaceAndSpace[] = _(" and ");
...
const u8 BattleText_Are[] = _("are");
const u8 BattleText_Are2[] = _("are");
