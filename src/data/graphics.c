...
const u8 gPokenavTrainerEyesBgTiles[] = INCBIN_U8("graphics/pokenav/trainereyes_bg.bin.lz");
const u8 gPokenavTrainerEyesRibbonsBgTiles[] = INCBIN_U8("graphics/pokenav/trainereyes_ribbons_bg.bin.lz");
const u8 gPokeNavTrainerEyesRibbonsTopBgTiles[] = INCBIN_U8("graphics/pokenav/trainereyes_ribbons_top_bg.bin");
const u8 gPokeNavTrainerEyesTopBgTiles[] = INCBIN_U8("graphics/pokenav/trainereyes_top_bg.bin");
const u8 gPokeNavTrainerEyesBottomBgTiles[] = INCBIN_U8("graphics/pokenav/trainereyes_bottom_bg.bin");
