...
const u8 gMainMenuString_MysteryEvents[] = _("이상한 사건");

// system text 2
const u8 SystemText_UpdatingSaveExternal[] = _("외부 데이터를 리포트에 갱신합니다\n잠시만 기다려 주십시오"); // がいぶデ-タにより レポ-トを こうしんしますｎしばらく おまちください
const u8 SystemText_SaveUpdated[] = _("리포트가 갱신되었습니다!"); // レポ-トが こうしんされました!
const u8 SystemText_SaveUpdatedExchangeBackup[] = _("리포트가 갱신되었습니다!\p더 이상 리포트를 쓸 수 없으므로\p백업 카트리지를\n교환해 주시기 바랍니다!\p자세한 내용은 닌텐도 서비스 센터로\n문의해 주십시오"); // レポ-トが こうしんされました!ｐこれいじょうレポ-トが かききれないのでｐバックアップカ-トリッジをｎこうかんしてください!ｐくわしくは にんてんどう サ-ビスセンタ- までｎおといあわせ ください
const u8 SystemText_SaveNotUpdated[] = _("리포트 갱신에 실패했습니다!\p백업 카트리지를\n교환해 주시기 바랍니다!\p자세한 내용은 닌텐도 서비스 센터로\n문의해 주십시오"); // レポ-トの こうしんは しっぱいしました!ｐバックアップカ-トリッジをｎこうかんしてください!ｐくわしくは にんてんどう サ-ビスセンタ- までｎおといあわせ ください

// save file text
const u8 gSaveFileCorruptMessage[] = _("리포트가 정확히 쓰여있지 않기 때문에\n전에 작성한 리포트를 읽겠습니다!"); // レポ-トが せいかくに かかれていないのでｎそのまえのレポ-トを よみます!
const u8 gSaveFileDeletedMessage[] = _("리포트의 내용이 사라졌다!"); // レポ-トの ないようが きえてしまった!

// system text 3
const u8 gBoardNotInstalledMessage[] = _("1M 서브보드가 꽂혀 있지 않습니다!"); // 1Mサブきばんが ささっていません!
const u8 gBatteryDryMessage[] = _("전지가 다 되어서\n시계가 움직이지 않습니다\p시계와 관련된 이벤트는 일어나지 않지만\n게임은 계속 플레이할 수 있습니다"); // でんちぎれの ためにｎとけいが うごかなくなりましたｐとけいに かんけいする できごとは おきませんがｎゲ-ムを つづけて あそぶことは できます
...
#ifdef SAPPHIRE
const u8 gDefaultBoyName1[] = _("해호");
#else
...
#ifdef SAPPHIRE
const u8 gDefaultGirlName1[] = _("해은");
#else
...
const u8 gDexText_UnknownHeight[] = _("???.?");
const u8 gDexText_UnknownWeight[] = _("???.?");
const u8 gDexText_HeightOf[] = _("m");
const u8 gDexText_WeightOf[] = _("kg");
const u8 gDexText_CryOf1[] = _("의$");
const u8 gDexText_CryOf2[] = _("{CLEAR_TO 2}울음소리$");
...
const u8 DexText_NumericalMode[] = _("번호순");
const u8 DexText_ABCMode[] = _("가나다순");
...
const u8 DexText_Alpha1[] = _("ㄱㄴ");
const u8 DexText_Alpha2[] = _("ㄷㄹ");
const u8 DexText_Alpha3[] = _("ㅁㅂ");
const u8 DexText_Alpha4[] = _("ㅅㅇ");
const u8 DexText_Alpha5[] = _("ㅈㅊ");
const u8 DexText_Alpha6[] = _("ㅋㅌ");
const u8 DexText_Alpha7[] = _("ㅍㅎ");
...
const u8 gMenuText_HOFNumber1[] = _("제 ");
const u8 gMenuText_HOFNumber2[] = _("회 전당등록!");
...
const u8 gContestStatsText_Sour[] = _("신맛");
const u8 gContestStatsText_Tasty[] = _("좋은맛");
const u8 gContestStatsText_Feel[] = _("부드러움");
...
const u8 gOtherText_ThatWillBe2[] = _("{STR_VAR_1} 말이죠!\n{STR_VAR_2}원인데 사실래요?");
...
const u8 gOtherText_ForgetMove123_2[] = _("{PAUSE 32}1, {PAUSE 15}2, {PAUSE 15}... {PAUSE 15}... {PAUSE 15}... {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}짠!\p{STR_VAR_1}{K_EUNNEUN} {STR_VAR_2}{K_EULREUL}\n깨끗이 잊었다!\p그리고...!{PAUSE_UNTIL_PRESS}");
...
const u8 OtherText_NothingToCut[] = _("눈앞에 벨 수 있는 것이 없습니다!"); // めのまえに きれるものが ありません!
const u8 OtherText_CantSurf[] = _("여기서는 탈 수 없습니다");
...
const u8 OtherText_ChoosePoke2[] = _("맡길 포켓몬을 선택해 주십시오"); // あずける ポケモンを えらんで ください
...
const u8 gOtherText_HP[] = _("{JPN}HP");
const u8 gOtherText_NextLvUntil[] = _("앞으로");
...
const u8 gOtherText_Ribbons00[] = _("현재");
...
const u8 OtherText_ContestMoves[] = _("콘테스트 기술"); // The "O" in "CONTEST" is actually a 0.
...
const u8 gOtherText_CantForgetHMs[] = _("중요한 기술입니다\n잊게 할 수 없습니다!");
...
const u8 gSecretBaseText_NoDecorInUse[] = _("굿즈가 놓여있지 않습니다!{PAUSE_UNTIL_PRESS}");
const u8 SecretBaseText_Tristan[] = _("원류"); // ヒロミ
...
const u8 OtherText_FreshWater[] = _("맛있는물{CLEAR_TO 0x48}¥200");
const u8 OtherText_SodaPop[] = _("미네랄사이다{CLEAR_TO 0x48}¥300");
const u8 OtherText_Lemonade[] = _("후르츠밀크{CLEAR_TO 0x48}¥350");
...
const u8 OtherText_TreeckoDoll[] = _("나무지기인형{CLEAR_TO 0x3a}1000개");
const u8 OtherText_TorchicDoll[] = _("아차모인형      1000개");
const u8 OtherText_MudkipDoll[] = _("물짱이인형      1000개");
const u8 OtherText_50Coins[] = _("  50개     {CLEAR_TO 0x03}1000원");
...
const u8 OtherText_TM32[] = _("기술머신32  1500개");
const u8 OtherText_TM29[] = _("기술머신29  3500개");
const u8 OtherText_TM35[] = _("기술머신35  4000개");
const u8 OtherText_TM24[] = _("기술머신24  4000개");
const u8 OtherText_TM13[] = _("기술머신13  4000개");
...
const u8 PCText_IsSelected[] = _("{K_EULREUL} 어떻게 하겠습니까?"); // 조사코드 작동 확인해야 함
const u8 PCText_JumpToWhichBox[] = _("어느 박스로 점프하겠습니까?");
const u8 PCText_DepositInWhichBox[] = _("어느 박스에 맡기겠습니까?");
const u8 PCText_WasDeposited[] = _("{K_EULREUL} 맡겼습니다"); // 조사코드 작동 확인해야 함
const u8 PCText_BoxIsFull[] = _("이 박스는 가득 찼습니다!");
const u8 PCText_ReleasePoke[] = _("정말 놓아주겠습니까?");
const u8 PCText_WasReleased[] = _("{K_EULREUL} 밖에 놓아주었다"); // 조사코드 작동 확인해야 함
...
const u8 PCText_SeeYa[] = _("지닌물건을 정리한다");
...
const u8 OtherText_SetWinMessage[] = _("대전에서 이겼을 때의 인사말");
const u8 OtherText_SetLossMessage[] = _("대전에서 졌을 때의 인사말");
const u8 OtherText_TheAnswer[] = _("대답은");
const u8 OtherText_MailMessage[] = _("메일에 적을 내용은");
const u8 OtherText_MailSalutation[] = _("메모에 적을 인사말은");
...
const u8 gOtherText_EditedTextNoSavePage1[] = _("편집한 단어는 저장되지");
const u8 gOtherText_EditedTextNoSavePage2[] = _("않습니다만 괜찮겠습니까?");
...
const u8 gOtherText_StopGivingMail[] = _("메일 건네주기를 그만두겠습니까?");
...
const u8 gOtherText_GoodSaying[] = _("좋은 말을 알려주자!");
...
const u8 gOtherText_WasEnhanced[] = _("이 올랐다!");
